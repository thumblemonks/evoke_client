...
context "updating a callback" do
  ...
  context "that actually exists" do
    setup do
      Evoke::HTTMockParty.put('/callbacks/good', {"guid" => "good", "url" => "http://a.b"}).
  ...
  context "that causes some failure" do
    setup do
      Evoke::HTTMockParty.put('/callbacks/bad', {"guid" => "bad"}).
  ...
  context "that does not exist" do
    setup do
      Evoke::HTTMockParty.put('/callbacks/what', {"guid" => "what"}).not_found
